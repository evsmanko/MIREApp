package evgeny.manko.schedule.datepicker;
...
import evgeny.manko.schedule.SettingsActivity;
...
public final class DatePickerTimeline extends LinearLayout implements MonthView.OnMonthSelectedListener {
    ...
    private void init(AttributeSet attrs, int defStyleAttr) {
        ...
        ImageButton settingIB = (ImageButton) view.findViewById(R.id.setting_ib);
        settingIB.setOnClickListener(new OnClickListener() {
            @Override
